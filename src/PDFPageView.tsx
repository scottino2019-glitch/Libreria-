...
export const PDFPage: React.FC<PDFPageProps> = ({ pdf, pageNumber, scale }) => {
  ...
  const [dimensions, setDimensions] = useState<React.CSSProperties>({ minHeight: '350px' });
  ...
  return (
    <div 
      style={dimensions}
      className="relative bg-white shadow-2xl ring-1 ring-black/10 mx-auto mb-8 transition-all hover:scale-[1.01] duration-500 overflow-hidden"
    >
